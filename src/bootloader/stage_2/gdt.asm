...
gdt_code:
    ...
    db 11001111b ; Four flags bits influencing segment size and
...
; 65,536 is max size of table but 2^16 holds between  0 and 65,535 so 
    ; setting the size as 1 means that table size will be seens as 2 and setting it 2 means it will be seen as 3 etc... so to 
