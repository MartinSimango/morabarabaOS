...
#define VBE_MODE_INFO_ADDRESS 0x8400
...
static struct _vbeModeInfo *VBE_MODE_INFO =
    (struct _vbeModeInfo *)VBE_MODE_INFO_ADDRESS;

#define VBE_BLOCK_SIZE (sizeof(VBE_MODE_INFO[0]))
